...
export function Home() {
    ...
    return (
        <div>
            ...
            <div>{message}</div>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={test_firebase}>Get message</button><br></br>
            <input type="text" value={your_message} onChange={(e) => { setYourMessage(e.target.value) }}></input><br></br>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={set_message}>Set message</button>
        </div>
    )
}
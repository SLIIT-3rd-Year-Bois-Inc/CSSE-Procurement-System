...
export default function DeliveryAcceptModal({ state, onClose, onSubmit }: DeliveryAcceptProps) {
        ...
        <div className="fixed flex justify-center items-center top-0 left-0 w-screen h-screen bg-[#00000083] z-50">
            <div className="rounded-xl p-8 px-5 bg-white min-w-[28em]">
                <div className="flex flex-row items-center mb-4">
                    ...
                    >
                        {state === DeliveryStates.ACCEPTED ? "Accepted" : "Returned"} Quantity :
                    </label>
                    <input
                        id="eta"
                        type="number"
                ...
                <div className="flex justify-center items-center mt-8">
                    <button
                        onClick={() => { onSubmit && onSubmit(count, note)}}
